...
pub enum TransportType {
    Memory,
    MemoryNoise(Option<x25519::PrivateKeyBytes>),
    PermissionlessMemoryNoise(Option<x25519::PrivateKeyBytes>),
    Tcp,
    TcpNoise(Option<x25519::PrivateKeyBytes>),
    PermissionlessTcpNoise(Option<x25519::PrivateKeyBytes>),
}
