...
impl<TSocket> NoiseSession<TSocket> {
    ...
    /// Read a message in place, returning a subslice of the passed message.
    /// The subslice effectively hides the authentication tag from the end of the message.
    ...
    /// Write a message in place, returning an authentication tag.
    /// Both the message and the authentication tag must be communicated to the other peer.
