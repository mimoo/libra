...
pub struct ValidatorInfo {
    ...
    // network
    network_identity_public_key: x25519::PublicKeyBytes,
}
...
impl ValidatorInfo {
    ...
    pub fn new_with_random_network_keys(
        ...
        let private_key = x25519::PrivateKeyBytes::for_test(rng);
        let network_identity_public_key: x25519::PublicKeyBytes = private_key.public_key();
    ...
    pub fn network_identity_public_key(&self) -> &x25519::PublicKeyBytes {
...
impl TryFrom<crate::proto::types::ValidatorInfo> for ValidatorInfo {
    ...
    fn try_from(proto: crate::proto::types::ValidatorInfo) -> Result<Self> {
        ...
        let network_identity_public_key =
            x25519::PublicKeyBytes::try_from(&proto.network_identity_public_key[..])?;
        Ok(Self::new(
            account_address,
            consensus_public_key,
            consensus_voting_power,
