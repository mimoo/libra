...
impl NetworkConfig {
    ...
    pub fn random_with_peer_id(&mut self, rng: &mut StdRng, peer_id: Option<PeerId>) {
        ...
        let identity_key = x25519::PrivateKeyBytes::for_test(rng);
...
pub struct NetworkKeyPairs {
    identity_private_key: PrivateKeyContainer<x25519::PrivateKeyBytes>,
    #[serde(skip)]
    pub identity_public_key: x25519::PublicKeyBytes,
...
impl NetworkKeyPairs {
    ...
    pub fn load(
        identity_private_key: x25519::PrivateKeyBytes,
    ...
    pub fn take_identity_key(&mut self) -> x25519::PrivateKeyBytes {
